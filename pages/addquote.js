...
function Addquote() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error('Failed to add QOD');
      }
      ...
      console.error('Error adding QOD:', error);
      toast.error("Failed to add QOD 😞");
    }
  };
            ...
            <div className="flex flex-wrap -m-2">
              <div className="p-2 w-full">
                <div className="relative">
                  <label htmlFor="author" className="leading-7 text-sm text-green-500">Author</label>
